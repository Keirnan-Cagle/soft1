...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        //Make it so that it is read only
        ...
        JScrollPane topScroller = new JScrollPane(this.tTop);
        JScrollPane bottomScroller = new JScrollPane(this.tBottom);
        ...
        //Add the buttons in the order they are going to show up on the
        //calculator. Unless I am mistaken, these do not need to be in any
        //Specific order, so I put them in this order because it just felt
        //right when looking at it on the GUI calculator.
        ...
        //The side buttons in the order I wanted them to be
        ...
        this.add(topScroller);
        this.add(bottomScroller);
        this.add(allButtons);
        ...
        //Should I have made final private values for these? probably.
        //Am I going to change it? No
        //I really hope there isn't a simpler way to do this
        //Because I could not figure any easy way out, so it just looks nasty
        //It was the only way I knew how to add listener's for events
    ...
    public void updatePowerAllowed(boolean allowed) {
        ...
        //Check if the numbers can use the power
    ...
    public void updateRootAllowed(boolean allowed) {
        ...
        //Check if the numbers can take a root
